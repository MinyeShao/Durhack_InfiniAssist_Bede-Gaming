<template>
	<view class="container">
		...
		<view class="inputframe" id="inputframe">
			<input class="input" cursor-spacing="10" type="text" placeholder=" Please enter information" v-model="send_text" @keydown.enter="send"></input>
	...
	export default {
		...
		methods: {
			welcome() {
    				   ...
    				   let welcome_msg_2 = {
        						from: "ai",
        						text: "This is an AI assistant based on Chat-GPT, designed to help you with various 									questions related to learning, life, and work."
    							};
				  }
					...
					uni.request({
						...
						success: function(res) {
							...
							if(res.data['code'] === '1') {
								...
								let msg = {
									from: "ai",
									text:  "Not logged in, please log in and try again."
								};
								_this.msgList.push(msg);
								plus.device.vibrate(150);
								setTimeout(() => {
						...
						fail: function(res) {
							...
							let msg = {
								from: "ai",
								text:  "The server is experiencing some issues, please try again later~"
							};
							_this.msgList.push(msg);
							plus.device.vibrate(150);
							setTimeout(() => {
